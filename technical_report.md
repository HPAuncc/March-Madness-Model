...
### Results Through Elite Eight (as of April 2, 2026)

The Kaggle dataset does not yet include 2026 tournament results. Game outcomes were manually sourced from NCAA.com and entered in Section 8 of the notebook.

| Round | Correct | Total | Accuracy |
|-------|---------|-------|----------|
| Round of 64 | 24 | 29 | 82.8% |
| Round of 32 | 12 | 16 | 75.0% |
| Sweet 16 | 5 | 8 | 62.5% |
| Elite Eight | 3 | 4 | 75.0% |
| **Main Bracket Total** | **44** | **57** | **77.2%** |

*Note: The First Four (play-in games) are excluded from this evaluation — those games match teams of identical seed, so the model has no meaningful differential signal and coin-flip accuracy is expected.*

### Interpretation

The model performed strongest in the Round of 64, where seed gaps and efficiency differentials are typically largest. Performance declined in the Sweet 16, where remaining teams are closely matched and genuine randomness dominates.

**Final Four teams (April 4):** UConn, Illinois, Michigan, Arizona

The championship game tips off April 7. This report will be updated with final results after that date. Once Kaggle publishes the 2026 results, the evaluation in Section 8 of the notebook can be re-run automatically against the official dataset.
